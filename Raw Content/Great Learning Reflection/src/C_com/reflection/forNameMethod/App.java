package C_com.reflection.forNameMethod;
...
public class App {
	...
	public static void main(String[] args) throws ClassNotFoundException {
		Class user = Class.forName("C_com.reflection.fornameMethod.User");
		System.out.println("Package Name : "+ user.getPackage().getName());
